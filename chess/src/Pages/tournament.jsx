...
function ChessTournaments() {
  ...
  const Card = ({ title, desc, icon, color }) => (
    <div className={`p-5 rounded-xl shadow border-l-4 ${color} bg-white/70 bg-opacity-90`}>
      <h3 className="text-lg font-semibold mb-1 ">{icon} {title}</h3>
  ...
  >
    ...
    {/* Content container with blur and transparency */}
    <div
    ...
    >
      ...
      <section className="mb-12">
        <center><h2 className="text-3xl font-semibold mb-[20px] text-center drop-shadow-md text-white bg-black/60 w-[180px] rounded pt-[3px] pb-[5px]">
          By Format
        </h2></center>
      ...
      {/* By Time Control */}
      <section className="mb-12">
        <center><h2 className="text-3xl font-semibold text-green-300 mb-8 text-center drop-shadow-md text-white bg-black/60 w-[280px] rounded pt-[3px] pb-[5px]">
          By Time Control
        </h2></center>
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 mt-[50px]">
      ...
      <section className="mb-8">
        <center><h2 className="text-3xl font-semibold text-purple-300 mb-8 text-center drop-shadow-md text-white bg-black/60 w-[280px] rounded pt-[3px] pb-[5px]">
          By Mode of Play
        </h2></center>
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 mt-[50px]">
          {modes.map((m, i) => (
