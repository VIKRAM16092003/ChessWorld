...
import instructionimg from "../../assets/instructionimg2.jpg";
...
const SwissGame = () => {
  ...
  useEffect(() => {
    if (isGameStarted && !result) {
      intervalRef.current = setInterval(() => {
        setWhiteTime((prev) =>
          currentTurn === "w" && prev > 0 ? prev - 1 : prev
        );
        setBlackTime((prev) =>
          currentTurn === "b" && prev > 0 ? prev - 1 : prev
        );
      }, 1000);
    } else {
  ...
  }, [isGameStarted, currentTurn, result]);
  ...
  return (
    <div>
      <div className="relative min-h-screen w-full h-[210vh]">
        ...
        <div className="relative z-10 min-h-screen w-full">
          <div className=" h-[180vh]">
            ...
            <div className="flex rounded-[10px] flex flex-row justify-evenly w-[90vw] bg-white/60 ml-[5vw] p-4 flex-row pl-[0px]">
              <div
                className="group flex flex-col justify-evenly h-[790px] mt-[19px] mb-2"
              ...
              >
                {pairings.map(([p1, p2], index) => (
                  ...
                  >
                    <p className="text-gray-800 font-[600] text-[18px]">
                      {p1.name} vs {p2.name} (Score: {p1.score}-{p2.score})
                    </p>

                    {/* Button hover changes only */}
                    {!isGameStarted && (
                      <button
                ...
                <div className="flex mt-[20px] rounded-[20px] text-center h-[400px]  hover:shadow-xl flex-col w-[200px] bg-white/60  rounded-[10px] shadow-lg mr-6">
                  <img
                    className="h-[400px] rounded-[20px]"
                    src={sideimg}
                    alt="sideimg"
                  />
                  <div className=" absolute w-[200px] bg-white/80 rounded-[20px] shadow-lg h-[400px] ">
                    <p
                      className="text-[30px] text-green-700 font-[700] pt-[100px]"
                      style={{
                        fontFamily: "Anton sans-serif",
                        fontWeight: "900",
                        fontStyle: "normal",
              ...
              <div className=" bg-white/80 shadow-lg rounded-[20px] mt-[10px] h-[850px] w-[75vw] ml-[vw] ">
                <div className="flex flex-row  justify-evenly ">
                  <div className="w-[40vw] h-[700px] mt-[10px]">
                    {isGameStarted && pairings[activeGame] ? (
                      ...
                      <div className="flex pt-[50px] mb-[30px] rounded-[20px] border-[#fff]  align-center flex flex-row justify-evenly mr-[10vw] w-[40vw]">
                        <div>
                          <h1
                            style={{
                              fontSize: "34px",
                        ...
                        <div className="left-[909px] absolute h-[600px] ">
                          <img
                            className="w-[200px] mt-[70px]  bottom=[200px] rounded-[30px] h-[600px]"
                            src={instructionimg}
                            alt="instructimg"
                          />
                          <div className="relative bottom-[600px] rounded-[30px]  w-[200px] h-[600px] bg-black/10"></div>
                          <div className="relative bottom-[1200px] rounded-[30px]  w-[200px] bg-white/10 h-[600px] "></div>
                        </div>
                      </div>
                    )}
                  </div>
                  <div className="flex flex-col mt-[200px]">
                    {playerstandings ? (
                      <>
                        <div className="flex flex-row justify-evenly mb-[30px]">
                          <div className="border-[0px] bg-white/60 shadow-md h-[120px] w-[150px] border-[#fff] rounded-[10px]">
                            <h4
