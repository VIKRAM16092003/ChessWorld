  ...
  return (
    <div className="flex flex-row h-[700px]">
      <div className="flex flex-col mb-[0px] h-[700px]">
        <p
          className="text-center text-[20px]  mt-[30px] mb-0 font-sans font-[700] text-[#F2F2F2] "
          style={{ marginTop: "0px" }}
        >
          {tacticgHeading}
        </p>
        <div className="grid mb-[10px] hover:-translate-y-1 border-[2px] rounded-[0px] border-[#B6B09F] grid-cols-8 w-[353px] h-[353px] mt-2 shadow-xl m-4">
          ...
          <ul className="pt-[30px] " style={{ paddingLeft: "19px" }}>
