...
function StartGame() {
  ...
  return (
    <div className="p-5 pt-3 bg-[#5c636a]/80">
      ...
      <div
        className={`bg-indigo-100 start-game-wrapper ${
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {["Play", "Puzzles", "Lessons", "Analysis", "Dark Mode"].map(
                (btn) => (
                  <button
                    key={btn}
            ...
            >
              {/* Move History Panel */}
              <div
                style={{ flex: "0.5", minWidth: "180px", textAlign: "center" }}
              >
                <h4>Moves</h4>
                <div
                  style={{
